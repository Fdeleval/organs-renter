...
Booking.create!({ organ_id: 1, user_id: 2, date_start: DateTime.new(2020, 11, 25, 22, 35, 0), date_end: DateTime.new(2020, 11, 30, 22, 35, 0), accepted: true})
Booking.create!({ organ_id: 2, user_id: 3, date_start: DateTime.new(2020, 11, 25, 22, 35, 0), date_end: DateTime.new(2020, 11, 30, 22, 35, 0), accepted: true})
...
Booking.create!({ organ_id: 4, user_id: 2, date_start: DateTime.new(2020, 11, 25, 22, 35, 0), date_end: DateTime.new(2020, 11, 30, 22, 35, 0), accepted: true})
